...
var Demo13 = React.createClass({
    ...
    render: function () {
        return (
            <div>
                <hr/>
                <Form data={this.getFormData()} className="" ref="form"/>
                <a href="javascript:;" onClick={this._handleClick}>提交</a>
                <Input onKeyUp={this._keyDown} value="1"/>
            </div>
        )
    }
});
