...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExtendLayer = React.createClass({displayName: "ExtendLayer",
	    componentDidMount: function () {
	    ...
	    render: function () {
	        return (
	            React.createElement(Layer, React.__spread({ref: "layer", 
	...
	var Dialog = (function () {
	    ...
	    return {
	        alert: function (param) {
	            ReactDOM.render(React.createElement(ExtendLayer, {title: param.title, content: param.content, confirm: "确定"}), msgArea);
	        },
	        confirm: function (param) {
	            ReactDOM.render(React.createElement(ExtendLayer, React.__spread({},  param)), msgArea);
	        }
	    }
	})();
